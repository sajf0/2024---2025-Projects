...
\section[صيغ التفاضل التربيعي]{صيغ التفاضل التربيعي \en{Differential Quadrature Formulas}}
...
\section[معاملات الوزن من الرتبة الأولى]{معاملات الوزن من الرتبة الأولى \en{Weight Coefficients of First Order}}
...
\subsection[طريقة بيلمان الأولى]{طريقة بيلمان الأولى \cite{Bellman} \en{(Billman's First Approach)}}
...
\subsection[طريقة بيلمان الثانية]{طريقة بيلمان الثانية \cite{Bellman} \en{(Billman's Second Approach)}}
...
\subsection[طريقة كوان و جانك]{طريقة كوان و جانك \cite{Quan} \en{(Quan \& Chang's Approach)}}
...
\section[معاملات الوزن من الرتبة الثانية]{معاملات الوزن من الرتبة الثانية \en{Weight Coefficients of Second Order}}
...
\subsection[طريقة ضرب المصفوفات]{طريقة ضرب المصفوفات \cite{chang_shu} \en{(Matrix Multiplication Method)}}
...
\section[اختيار نقاط الشبكة]{اختيار نقاط الشبكة \en{Choice of Grid Points}}
...
\subsection[النقاط متساوية الأبعاد]{النقاط متساوية الأبعاد \en{(Equally Spaced Grid Points)}}
...
\subsection[نقاط شيبيشيف-كاوس-لوباتو]{نقاط شيبيشيف-كاوس-لوباتو \en{(Chebyshev-Gauss-Lobatto Points)}}
