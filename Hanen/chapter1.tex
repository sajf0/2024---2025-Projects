\chapter{مفاهيم اولية في الزمر والحلقات}

\begin{definition}[\cite{groups1}]
	\addcontentsline{toc}{section}{مفاهيم اساسية}
...
\begin{definition}[\cite{groups2}]
	\addcontentsline{toc}{section}{تعريف الزمرة}
...
\begin{definition}[\cite{groups2}]
	\addcontentsline{toc}{section}{زمرة الاعداد الصحيحة}
...
$H=\{0,2,4,6,8,10\}$ ، $K=\{0,3,6,9\}$ اذن\\
 ...
 \begin{definition}[\cite{groups2}]
 	\addcontentsline{toc}{section}{الزمرة الناظمية}
 ...
 \end{theorem}
  ...
  \begin{definition}[\cite{groups2}]
  	\addcontentsline{toc}{section}{زمرة القسمة}
 ...
 \begin{definition}[\cite{rings}]
 	\addcontentsline{toc}{section}{تعريف الحلقة}
 ...
 \begin{definition}[\cite{rings}]
 	\addcontentsline{toc}{section}{الساحة التامة}
 ...
 \begin{definition}[\cite{rings}]
 	\addcontentsline{toc}{section}{الحلقة الجزئية}
 ...
 \begin{definition}[\cite{rings}]
 	\addcontentsline{toc}{section}{تعريف المثالية}
