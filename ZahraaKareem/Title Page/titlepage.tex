...
\begin{titlepage}
	...
	\begin{center}
		...
		\vspace{1cm}
\Large\textbf{
تطوير طرق تكرارية جديدة لحل المعادلات غير الخطية بإستخدام تقنيات عددية مُحسنة 
}\\
\Large\textbf{\LR{
Developing new iterative methods for solving nonlinear equations using improved numerical techniques
}}\\
		\vspace{12pt}
		\rule{100mm}{0.5mm}
	\end{center}
