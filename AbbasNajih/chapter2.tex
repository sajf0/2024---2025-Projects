...
\section[معادلة الحركة \en{Equation of Motion} ]{معادلة الحركة \en{Equation of Motion} [6]}
...
\section[معادلة تدفق بوازوي \en{Poiseuille's Flow Equation}]{معادلة تدفق بوازوي \en{Poiseuille's Flow Equation} [7]}
...
\begin{itemize}
	...
	\item $\vec{v} \cdot \nabla v_z$: التسارع الناتج عن الحمل \LR{(Convective acceleration)}، أي تأثير التغير المكاني على السرعة.
	\item $-{\partial p}/{\partial z}$: تدرج الضغط في الاتجاه $z$، أي القوة الناتجة عن الضغط.
	\item $\mu$: اللزوجة الديناميكية \LR{(Dynamic viscosity)} للمائع.
...
\section[الحركة التوافقية البسيطة \en{Simple Harmonic Motion}]{الحركة التوافقية البسيطة \en{Simple Harmonic Motion} [8]}
